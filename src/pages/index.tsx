    ...
    <div className="flex flex-col md:flex-row bg-zinc-950 md:h-screen">
      ...
      <div className="mt-5 md:mt-0 p-5 md:p-16 text-zinc-200 text-lg grow relative flex justify-center items-center">
        ...
        <div className="mb-14 flex flex-col md:flex-row">
          <a href="/work" className='bg-zinc-200 text-zinc-900 px-8 py-2 rounded-3xl md:mr-5 mb-5 md:mb-0'><i className="bi bi-files mr-4"></i>Projects</a>
          <a target="_blank" href="/resume.pdf" className="text-zinc-200 border border-zinc-200 border-2 px-8 py-2 rounded-3xl"><i className="bi bi-box-arrow-up-right mr-4 "></i>Resume</a>
        </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center mb-5 md:mb-0">
          ...
          <a className="bg-zinc-200 text-zinc-900 px-3 py-2 mr-5 rounded-full" href="https://www.linkedin.com/in/jay-ganatra/"><i className="fa-brands fa-linkedin-in"></i></a>
          <a className="bg-zinc-200 text-zinc-900 px-3 py-2 mr-5 rounded-full" href="https://github.com/GanatraJay2000"><i className="fa-brands fa-github"></i></a>
          </div>
          <a className='text-zinc-200 border border-zinc-200 border-2 px-8 py-2 rounded-3xl' href="mailto:ganatrajay2000@gmail.com"><i className="bi bi-envelope mr-4"></i>Email Me</a>
        </div>
      </div>
      </div>
    </div>
